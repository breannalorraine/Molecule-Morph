...
void ofApp::draw(){
    ...
    ofDrawBitmapString( "1- morph to cube, 2- morph to lsd molecule---Lysergic acid diethylamide, a psychedelic drug well known for altered thinking processes, closed & open-eye visuals & synesthesia.", 20, 20 );
